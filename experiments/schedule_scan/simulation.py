...
def simulate_point(candidate: dict, audit: dict, p: float, output: Path,
                   ...
                   max_shots: int = 100_000_000, relative_error: float = .10,
                   batch_size: int = 64, run_seed: int = 20260921) -> dict:
    """Simulate one independently seeded candidate at p=.003 or .0025.
    ...
    """
    if p not in (0.003, 0.0025):
        raise ValueError("This schedule scan is restricted to p=.003 and .0025")
