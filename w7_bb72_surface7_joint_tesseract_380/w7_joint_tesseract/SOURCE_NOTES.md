...
Default idle noise is zero by user preference. IBM's original idle noise is p. This campaign uses R=d: 7, 6, 7 noisy rounds for weight-7, BB72, and surface7, respectively; two ideal closing cycles are additional. Do not label its results as an exact replication of Figure 3.
